<?php
require WP_MCM_PLUGIN_DIR . '/api/class-api-v3-client.php';
/**
 * Class API_v3
 */
class Wp_Mailchimp_Master_API_v3 {

    /**
     * @var WP_Mailchimp_Client
     */
    protected $client;
    ...
    public function __construct( $api_key ) {
        $this->client = new Wp_Mailchimp_Master_v3_Client( $api_key );
    }
    ...
    public function get_templates( array $args = array() ) {
        ...
        if( is_object( $data ) && isset( $data->templates ) ) {
